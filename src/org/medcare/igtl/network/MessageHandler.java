 ...
 * must be adapted corresponding to the need of each use User must adapt
 * Capability list, to be able to send the right capability list and to have a
 * correct error management for incorrect capability request
 * 
...
public abstract class MessageHandler {
	...
	System.out.println("Receiv ed message with capability value="
		+ messageType);
	...
	manageError("MessageHandler Message Type not Found " + messageType,
		new Exception("MessageHandler Message Type not Found"),
		ErrorManager.MESSAGE_NOT_MANAGED);
	return false;
    }
