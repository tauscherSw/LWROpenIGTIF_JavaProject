...
public class GenericIGTLinkClient extends OpenIGTClient implements
    ...
    /**
     * This method will be called by the IGT server when a transform is
     * received. Supports: TRANSFORM QTRANS QTRANSFORM POSITION
     * 
     * @param name
     ...
     *            the image
     * @param t
     *            A transform of where the image is
     */
