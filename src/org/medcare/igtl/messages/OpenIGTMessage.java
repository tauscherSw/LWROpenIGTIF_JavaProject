...
public abstract class OpenIGTMessage {
	...
	// && !isBodyUnpacked
	    ...
	    // throw new
	    // CrcException("Crc control fail during unpacking CRC is: "+header.getCrc()+" calculated: "+bytesArray.crc64(body,
	    // body.length, 0L));
	    // }
	}
	// TODO fix when CRC is fixed
	...
	// Log.debug("Header actual size: "+
	// header_Bytes.length+" defined size: "+Header.LENGTH+" : "+new
	// ByteList( header.getBytes()));
