...
public class PositionMessage extends OpenIGTMessage {
    ...
    /**
     *** To create body from image_header and image_data SetPositionData must have
     * called first
     * 
     *** 
    ...
    /**
     *** To create position_data from image characteristics and to get the byte
     * array to send
     * 
     * @param position
     * @param quaternion
     ...
     */
    public byte[] setPositionData(double position[], RotationNR quaternion,
	    int quaternionSize) {
