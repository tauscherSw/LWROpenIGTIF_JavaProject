...
public class Status {
    ...
    public static int STATUS_RESOURCE_ERROR = 11; /*
						   * Not enough resource
						   * (memory, storage etc)
						   */
    public static int STATUS_UNKNOWN_INSTRUCTION = 12; /*
						        * Illegal/Unknown
						        * instruction
						        */
    public static int STATUS_NOT_READY = 13; /* Device not ready (starting up) */
    public static int STATUS_MANUAL_MODE = 14; /*
					        * Manual mode (device does not
					        * accept commands)
					        */
