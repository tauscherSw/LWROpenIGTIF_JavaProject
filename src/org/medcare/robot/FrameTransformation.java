...
public class FrameTransformation {
    ...
    /*
     * public void setTransformMatrix(double[][] rotationMatrix, double[]
     * positionVector) { this.transformMatrix[0][0] = rotationMatrix[0][0];
     ...
     * this.transformMatrix[3][0] = 0.0; this.transformMatrix[3][1] = 0.0;
     * this.transformMatrix[3][2] = 0.0; this.transformMatrix[3][3] = 1.0; }
     */
