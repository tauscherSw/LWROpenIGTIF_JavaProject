...
public class IGTLndarrayJNI {
    ...
    public final static native void igtl_ndarray_info_type_set(long jarg1,
	    igtl_ndarray_info jarg1_, short jarg2);

    public final static native short igtl_ndarray_info_type_get(long jarg1,
	    igtl_ndarray_info jarg1_);

    public final static native void igtl_ndarray_info_dim_set(long jarg1,
	    igtl_ndarray_info jarg1_, short jarg2);

    public final static native short igtl_ndarray_info_dim_get(long jarg1,
	    igtl_ndarray_info jarg1_);

    public final static native void igtl_ndarray_info_size_set(long jarg1,
	    igtl_ndarray_info jarg1_, long jarg2);

    public final static native long igtl_ndarray_info_size_get(long jarg1,
	    igtl_ndarray_info jarg1_);

    public final static native void igtl_ndarray_info_array_set(long jarg1,
	    igtl_ndarray_info jarg1_, long jarg2);

    public final static native long igtl_ndarray_info_array_get(long jarg1,
	    igtl_ndarray_info jarg1_);
    ...
    public final static native void igtl_ndarray_init_info(long jarg1,
	    igtl_ndarray_info jarg1_);

    public final static native int igtl_ndarray_alloc_info(long jarg1,
	    igtl_ndarray_info jarg1_, long jarg2);

    public final static native int igtl_ndarray_free_info(long jarg1,
	    igtl_ndarray_info jarg1_);

    public final static native int igtl_ndarray_unpack(int jarg1, long jarg2,
	    long jarg3, igtl_ndarray_info jarg3_, java.math.BigInteger jarg4);

    public final static native int igtl_ndarray_pack(long jarg1,
	    igtl_ndarray_info jarg1_, long jarg2, int jarg3);

    public final static native java.math.BigInteger igtl_ndarray_get_size(
	    long jarg1, igtl_ndarray_info jarg1_, int jarg2);

    public final static native java.math.BigInteger igtl_ndarray_get_crc(
	    long jarg1, igtl_ndarray_info jarg1_, int jarg2, long jarg3);
}
