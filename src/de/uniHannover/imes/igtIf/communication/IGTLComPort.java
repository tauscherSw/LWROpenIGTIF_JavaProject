...
public final class IGTLComPort {
	...
	log.info("Setting up connection to port " + serverPort);
	...
	log.info("Waiting for incoming connections at port " + serverPort);
	...
	log.info("Connection to the server with the ip "
		+ openIGTClient.getInetAddress().toString() + " and the port "
